...
if [ "$SHARD_COUNT" -gt 1 ]; then RESULT_DIR=$(printf "/result/experiments/shard-%03d-of-%03d" "$SHARD_INDEX" "$SHARD_COUNT"); fi
...
"$@"
echo "Matrix report written under result/experiments"
